package dev.matteomac81888.echo.widget
...
import dev.matteomac81888.echo.playback.PlayerCommands.likeCommand
import dev.matteomac81888.echo.playback.PlayerCommands.repeatCommand
import dev.matteomac81888.echo.playback.PlayerCommands.repeatOffCommand
import dev.matteomac81888.echo.playback.PlayerCommands.repeatOneCommand
import dev.matteomac81888.echo.playback.PlayerCommands.resumeCommand
import dev.matteomac81888.echo.playback.PlayerCommands.unlikeCommand
import dev.matteomac81888.echo.playback.PlayerService.Companion.getPendingIntent
import dev.matteomac81888.echo.playback.ResumptionUtils.recoverIndex
import dev.matteomac81888.echo.playback.ResumptionUtils.recoverTracks
...
abstract class BaseWidget : AppWidgetProvider(), KoinComponent {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "dev.matteomac81888.echo.widget.PLAY_PAUSE"
        const val ACTION_PREVIOUS = "dev.matteomac81888.echo.widget.PREVIOUS"
        const val ACTION_NEXT = "dev.matteomac81888.echo.widget.NEXT"
        const val ACTION_LIKE = "dev.matteomac81888.echo.widget.LIKE"
        const val ACTION_UNLIKE = "dev.matteomac81888.echo.widget.UNLIKE"
        const val ACTION_REPEAT = "dev.matteomac81888.echo.widget.REPEAT"
        const val ACTION_REPEAT_OFF = "dev.matteomac81888.echo.widget.REPEAT_OFF"
        const val ACTION_REPEAT_ONE = "dev.matteomac81888.echo.widget.REPEAT_ONE"
        const val ACTION_RESUME = "dev.matteomac81888.echo.widget.RESUME"
