package dev.matteomac81888.echo.ui.player
...
import dev.matteomac81888.echo.databinding.FragmentPlayerBinding
import dev.matteomac81888.echo.playback.MediaItemUtils.background
import dev.matteomac81888.echo.playback.MediaItemUtils.context
import dev.matteomac81888.echo.playback.MediaItemUtils.extensionId
import dev.matteomac81888.echo.playback.MediaItemUtils.isLiked
import dev.matteomac81888.echo.playback.MediaItemUtils.isLoaded
import dev.matteomac81888.echo.playback.MediaItemUtils.showBackground
...
import dev.matteomac81888.echo.ui.common.UiViewModel.Companion.applyHorizontalInsets
import dev.matteomac81888.echo.ui.common.UiViewModel.Companion.applyInsets
import dev.matteomac81888.echo.ui.common.UiViewModel.Companion.isFinalState
import dev.matteomac81888.echo.ui.common.UiViewModel.Companion.setupPlayerMoreBehavior
import dev.matteomac81888.echo.ui.media.MediaFragment
import dev.matteomac81888.echo.ui.media.more.MediaMoreBottomSheet
import dev.matteomac81888.echo.ui.player.PlayerColors.Companion.defaultPlayerColors
import dev.matteomac81888.echo.ui.player.PlayerColors.Companion.getColorsFrom
import dev.matteomac81888.echo.ui.player.PlayerTrackAdapter.Companion.configureClicking
import dev.matteomac81888.echo.ui.player.quality.FormatUtils.getDetails
import dev.matteomac81888.echo.ui.player.quality.QualitySelectionBottomSheet
import dev.matteomac81888.echo.utils.ContextUtils.emit
import dev.matteomac81888.echo.utils.ContextUtils.getSettings
import dev.matteomac81888.echo.utils.ContextUtils.observe
import dev.matteomac81888.echo.utils.image.ImageUtils.loadBlurred
import dev.matteomac81888.echo.utils.ui.AnimationUtils.animateVisibility
import dev.matteomac81888.echo.utils.ui.AutoClearedValue.Companion.autoClearedNullable
import dev.matteomac81888.echo.utils.ui.CheckBoxListener
import dev.matteomac81888.echo.utils.ui.SimpleItemSpan
import dev.matteomac81888.echo.utils.ui.UiUtils.dpToPx
import dev.matteomac81888.echo.utils.ui.UiUtils.hideSystemUi
import dev.matteomac81888.echo.utils.ui.UiUtils.isLandscape
import dev.matteomac81888.echo.utils.ui.UiUtils.isRTL
import dev.matteomac81888.echo.utils.ui.UiUtils.marquee
import dev.matteomac81888.echo.utils.ui.UiUtils.toTimeString
import dev.matteomac81888.echo.utils.ui.ViewPager2Utils.registerOnUserPageChangeCallback
import dev.matteomac81888.echo.utils.ui.ViewPager2Utils.supportBottomSheetBehavior
