...
import dev.matteomac81888.echo.MainActivity
import dev.matteomac81888.echo.MainActivity.Companion.AMOLED_KEY
import dev.matteomac81888.echo.MainActivity.Companion.BACK_ANIM
import dev.matteomac81888.echo.MainActivity.Companion.BIG_COVER
import dev.matteomac81888.echo.MainActivity.Companion.COLOR_KEY
import dev.matteomac81888.echo.MainActivity.Companion.CUSTOM_THEME_KEY
import dev.matteomac81888.echo.MainActivity.Companion.LIQUID_GLASS_KEY
import dev.matteomac81888.echo.MainActivity.Companion.THEME_KEY
import dev.matteomac81888.echo.MainActivity.Companion.defaultColor
import dev.matteomac81888.echo.R
import dev.brahmkshatriya.echo.common.models.ImageHolder.Companion.toResourceImageHolder
import dev.matteomac81888.echo.playback.MediaItemUtils.SHOW_BACKGROUND
import dev.matteomac81888.echo.ui.common.UiViewModel.Companion.BACKGROUND_GRADIENT
import dev.matteomac81888.echo.ui.common.UiViewModel.Companion.NAVBAR_GRADIENT
import dev.matteomac81888.echo.ui.player.PlayerFragment.Companion.DYNAMIC_PLAYER
import dev.matteomac81888.echo.utils.ContextUtils.SETTINGS_NAME
import dev.matteomac81888.echo.utils.ui.AnimationUtils.ANIMATIONS_KEY
import dev.matteomac81888.echo.utils.ui.AnimationUtils.SCROLL_ANIMATIONS_KEY
import dev.matteomac81888.echo.utils.ui.FastScrollerHelper.SCROLL_BAR
import dev.matteomac81888.echo.utils.ui.prefs.ColorListPreference
import dev.matteomac81888.echo.utils.ui.prefs.MaterialListPreference
    ...
    class LookPreference : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            PreferenceCategory(context).apply {
                ...
                SwitchPreferenceCompat(context).apply {
                    key = LIQUID_GLASS_KEY
                    title = getString(R.string.liquid_glass)
                    summary = getString(R.string.liquid_glass_summary)
                    layoutResource = R.layout.preference_switch
                    isIconSpaceReserved = false
                    setDefaultValue(false)
                    addPreference(this)
        ...
        val listener = SharedPreferences.OnSharedPreferenceChangeListener { _, key ->
            when (key) {
                ...
                BIG_COVER, NAVBAR_GRADIENT, BACKGROUND_GRADIENT, LIQUID_GLASS_KEY,
                    -> {
