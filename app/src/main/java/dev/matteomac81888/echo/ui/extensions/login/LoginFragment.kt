// START OF FILE main/java/dev/matteomac81888/echo/ui/extensions/login/LoginFragment.kt
package dev.matteomac81888.echo.ui.extensions.login
...
import dev.matteomac81888.echo.databinding.FragmentExtensionLoginCustomInputBinding
import dev.matteomac81888.echo.databinding.FragmentExtensionLoginSelectorBinding
import dev.matteomac81888.echo.databinding.FragmentGenericCollapsableBinding
import dev.matteomac81888.echo.databinding.FragmentWebviewBinding
import dev.matteomac81888.echo.databinding.ItemExtensionButtonBinding
import dev.matteomac81888.echo.databinding.ItemInputBinding
import dev.matteomac81888.echo.extensions.exceptions.AppException
...
import dev.matteomac81888.echo.ui.extensions.WebViewUtils.configure
    ...
    class Selector : Fragment(R.layout.fragment_extension_login_selector) {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            clients.forEachIndexed { index, pair ->
                ...
                // BUG FIX: Forza la larghezza del bottone a Match Parent per evitare lo schiacciamento
                button.layoutParams = LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT
                ).apply {
                    setMargins(0, 0, 0, 16.dpToPx(requireContext()))
                }
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            binding.run {
                form.inputFields.forEachIndexed { index, field ->
                    ...
                    // BUG FIX: Forza la larghezza del TextInputLayout a Match Parent
                    input.root.layoutParams = LinearLayout.LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT
                    ).apply {
                        setMargins(0, 0, 0, 16.dpToPx(requireContext()))
                ...
                // Assicurati che anche il bottone Login sia largo il giusto
                loginCustomSubmit.layoutParams = LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT
                ).apply {
                    setMargins(0, 32.dpToPx(requireContext()), 0, 0)
                }
