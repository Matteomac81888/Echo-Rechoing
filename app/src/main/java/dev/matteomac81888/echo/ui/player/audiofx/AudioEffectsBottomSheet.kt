package dev.matteomac81888.echo.ui.player.audiofx
...
import dev.matteomac81888.echo.databinding.DialogPlayerAudioFxBinding
import dev.matteomac81888.echo.databinding.FragmentAudioFxBinding
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.BASS_BOOST
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.CHANGE_PITCH
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.CUSTOM_EFFECTS
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.PLAYBACK_SPEED
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.deleteFxPrefs
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.getFxPrefs
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.globalFx
import dev.matteomac81888.echo.playback.listener.EffectsListener.Companion.speedRange
import dev.matteomac81888.echo.ui.player.PlayerViewModel
import dev.matteomac81888.echo.utils.ContextUtils.observe
import dev.matteomac81888.echo.utils.PermsUtils.registerActivityResultLauncher
import dev.matteomac81888.echo.utils.ui.AutoClearedValue.Companion.autoCleared
import dev.matteomac81888.echo.utils.ui.RulerAdapter
